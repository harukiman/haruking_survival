...
Game.ITEMS = {
  ...
  tank:          { name:'戦車', stack:1, color:'#4a5a3c', vehicle:'tank', fuelVeh:true, tankCannon:{ directDmg:110, blastDmg:36, blastRadius:3.8, speed:9, range:12, cd:42, knock:24 }, flavor:'一人乗りの装甲戦車。鈍いが頑強。砲塔は移動と別に旋回でき、狙った方向へ砲弾を撃ち出す。砲弾は着弾か一定距離で炸裂し、直撃は特大・爆風は広範囲を薙いで敵を大きく吹き飛ばす。' },
  ...
  fighter_jet:   { name:'戦闘機', stack:1, color:'#8a96c0', vehicle:'jet', fuelVeh:true, jetGun:{ dmg:12, burst:10, spread:0.05, speed:13, rate:2.5 }, flavor:'一人乗りの戦闘機。空を高速で駆け、あらゆる地形を越える。攻撃1タップで機首砲が真っ直ぐ10連射(弾丸1消費)。ミニガンの2倍レートの弾幕で薙ぎ払い、地形も封印壁など特殊物以外は撃ち砕く(鉱石は耐久を削って数発で破壊)。' },
