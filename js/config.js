...
Game.ITEMS = {
  ...
  lockon_launcher:{ name:'ロックオンミサイルランチャー', stack:1, color:'#4a5240', tool:'gun', mag:2, ammo:'missile', fireDmg:52, cd:40, explosive:2.6, bspeed:14, bkind:'missile', homing:true, range:22, gunsfx:'missile_launch', flavor:'肩掛け式のロックオン式ミサイル発射器。放たれたミサイルは最寄りの敵へ自ら曲がって追尾し、着弾または一定距離で炸裂する。' },
  ...
  fighter_jet:   { name:'戦闘機', stack:1, color:'#8a96c0', vehicle:'jet', fuelVeh:true, jetGun:{ dmg:12, burst:10, spread:0.05, speed:13, rate:2.5 }, jetMissile:{ dmg:70, explosive:2.8, speed:18, range:16, cd:26 }, flavor:'一人乗りの戦闘機。空を高速で駆け、あらゆる地形を越える。攻撃1タップで機首砲が真っ直ぐ10連射(弾丸1消費)。ミニガンの2倍レートの弾幕で薙ぎ払い、地形も封印壁など特殊物以外は撃ち砕く(鉱石は耐久を削って数発で破壊)。' },
  ...
  bomber:        { name:'爆撃機', stack:1, color:'#6a7060', vehicle:'bomber', fuelVeh:true, bomberBay:true, bomberMissile:{ dmg:85, explosive:3.0, speed:16, range:20, cd:36, homing:true }, flavor:'一人乗りの爆撃機。攻撃ボタンで搭載爆弾を投下、L2で自動追尾ミサイルを発射する。ミサイルは最寄りの敵へ自ら曲がって飛ぶ。' },
...
Game.ITEM_GLYPH = {
  ...
  ammo_9mm:'🔸', ammo_556:'🔹', ammo_762:'🟤', shell_12g:'🔴', ammo_50:'🟠', rocket_ammo:'🧨', he_slug:'🔩', missile:'🚀',
