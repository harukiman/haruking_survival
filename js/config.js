...
Game.ITEMS = {
  ...
  moon_stew:   { name:'月光きのこのシチュー', stack:8, color:'#c9a8ff', food:16, sanityGain:22, flavor:'発光キノコと月の光を煮込んだ淡く光るシチュー。啜ると心の靄が晴れていく——影の世界で正気を取り戻せる唯一の料理。' },
  honey_toast: { name:'木の実の蜜トースト', stack:8, color:'#e8b45a', food:26, buff:{type:'swiftness', dur:600}, flavor:'焼きたてのパンに木の実と蜜をたっぷり。食べると足取りが軽くなる(俊足20秒)。' },
...
Game.RECIPES = [
  ...
  { out:{id:'moon_stew', n:1}, in:{luminous_cap:2, glow_spore:1, berry:2}, station:'campfire' },
  { out:{id:'honey_toast', n:2}, in:{bread:1, berry:3}, station:'campfire' },
