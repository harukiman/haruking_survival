...
Game.ITEMS = {
  ...
  fighter_jet:   { name:'戦闘機', stack:1, color:'#8a96c0', vehicle:'jet', fuelVeh:true, jetGun:{ dmg:12, burst:10, spread:0.05, speed:13, rate:2.5 }, jetMissile:{ dmg:70, explosive:2.8, speedStart:9, speedMax:22, accel:1.4, dur:40, cd:26, ammo:'missile' }, flavor:'一人乗りの戦闘機。空を高速で駆け、あらゆる地形を越える。攻撃1タップで機首砲が真っ直ぐ10連射(弾丸1消費)。ミニガンの2倍レートの弾幕で薙ぎ払い、地形も封印壁など特殊物以外は撃ち砕く(鉱石は耐久を削って数発で破壊)。' },
  ...
  bomber:        { name:'爆撃機', stack:1, color:'#6a7060', vehicle:'bomber', fuelVeh:true, bomberBay:true, bomberMissile:{ dmg:32, explosive:1.9, speedStart:5, speedMax:23, accel:1.0, dur:60, cd:44, homing:true, ammo:'homing_missile', count:4, every:4, spread:0.42, small:true }, flavor:'一人乗りの爆撃機。攻撃ボタンで搭載爆弾を投下、L2で誘導ミサイルを一斉発射する。1発で小型・高速の追尾ミサイルが4発飛び、それぞれ最寄りの敵へ曲がって飛ぶ。' },
