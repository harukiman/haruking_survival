...
Game.Settings = (function () {
  ...
  const DEF = {
    ...
    leftHanded: false, joyFollow: true, dmgNumbers: true, showFps: false, screenShake: true, lowHpWarn: true, ambient: true, homeCompass: true, peerCompass: true, lookAhead: true,
