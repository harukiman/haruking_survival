...
Game.Settings = (function () {
  ...
  const DEF = {
    ...
    btnSize: 100, btnOpacity: 92, joySens: 100, padCursor: 100,
    leftHanded: false, joyFollow: true, padRumble: true, dmgNumbers: true, showFps: false, screenShake: true, lowHpWarn: true, ambient: true, homeCompass: true, peerCompass: true, lookAhead: true, reduceFlash: false,
    keybinds: { up: 'w', down: 's', left: 'a', right: 'd', mine: ' ', place: 'q', use: 'g', inv: 'e', stats: 'c', map: 'n', roll: 'r', dash: 'shift', shift: 'f', reload: 'v' }, // input.jsのDEF_BINDSと同期を保つ
    padbinds: { mine: 0, fire: 7, place: 2, shift: 3, roll: 1, hotbarPrev: 4, hotbarNext: 5, dash: 6, inv: 9, map: 11, stats: 10, opts: 8, zoom: 17 }, // input.jsのPAD_DEFと同期を保つ
  };
  let s = load();
  function load() {
