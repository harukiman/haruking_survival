...
Game.Cutscene = (function () {
  ...
  const BOSS = {
    ...
    storm_sovereign:{ name: '嵐の主', col: '#8fc8f0', sil: 'orb', intro: ['雲海が渦を巻き、雷光を纏う竜が舞い降りる', '「空を侵す矮小な者よ——雷に還れ」'], outro: ['嵐は凪ぎ、澄んだ空だけが残った', '— 嵐帝の戈、その手に稲妻を —'] },
    ruin_king:{ name: '玉座の王', col: '#d8c078', sil: 'tall', intro: ['崩れた玉座に、黄金の王が朽ちてなお在す', '「都を侵す者よ——臣下となるか、塵となるか」'], outro: ['王は玉座もろとも崩れ、黄金の塵となった', '— 玉座の王笏、威厳を継ぐ者へ —'] },
    void_emperor:{ name: '虚無の帝', col: '#b088e8', sil: 'tall', intro: ['あわいの奥、虚無を纏う帝が像を結ぶ', '「存在と非在のあわいで——お前は、どちらだ」'], outro: ['帝は像を失い、あわいへ溶けて還った', '— 虚無の王冠、境を統べる証 —'] },
