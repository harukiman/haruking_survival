...
Game.STORY = [
  ...
  { id: 'skyisles', title: '断章 ― 雲の岸', trigger: '風の祭壇から空島へ昇ったとき', col: '#3a5a6a', scenes: [
    { text: '風の祭壇に羽根を掲げれば、渦が足もとから立ちのぼる。\nからだは雲を貫き、地上のいっさいが遠ざかってゆく。', col: '#7a6a44', col2: '#f0ead0', icon: '🪶', d: 5000, audio: 'riser' },
    { text: '雲海のうえに、緑の浮島がひらける。\nここは裂けた世界のどちらにも属さぬ、空の岸。誰も還らぬ高みに、風晶だけが唄っている。', col: '#3a5a6a', col2: '#d8f0f4', icon: '☁', d: 5400, audio: 'shimmer' },
    { text: '番人は問う。「風を纏う覚悟はあるか」と。\n——ここで鍛えた刃は、地上のどんな鎖より軽く、そして遠くまで斬り裂くだろう。', col: '#2a4450', col2: '#bfe8e0', icon: '⚔', d: 5200, audio: 'swell' },
  ] },
  { id: 'ruincity', title: '断章 ― 沈黙の都', trigger: '古の門をひらき、都市へ踏み入ったとき', col: '#5a4e34', scenes: [
    { text: '古の鍵が門の紋様に噛み合うと、金の光が奥へと道をひらいた。\n水濠に囲まれた、名も失われた都市。', col: '#6a5a38', col2: '#f0e0a8', icon: '🗝', d: 5000, audio: 'boom' },
    { text: '崩れた列柱、苔むした石畳、顔の欠けた石像。\nかつてここに満ちた声は、いま沈黙だけになって広場に降り積もっている。', col: '#4a4430', col2: '#d8cca0', icon: '🏛', d: 5400, audio: 'choir' },
    { text: '守番だけが、朽ちてなお持ち場を離れない。\n——遺されたのは、還る場所を失った者たちの、終わらない忠義だけだ。', col: '#3a3420', col2: '#e0cf90', icon: '⚔', d: 5200, audio: 'swell' },
  ] },
  { id: 'riftvoid', title: '断章 ― 世界の隙間', trigger: '虚ろな鍵で狭間へ落ちたとき', col: '#2a1840', scenes: [
    { text: '虚ろな鍵をかざすと、空間そのものが縦に裂けた。\n光でも影でもない色が、渦を巻いてこちらを覗いている。', col: '#241038', col2: '#c0a0f0', icon: '🗝', d: 5000, audio: 'crack' },
    { text: 'ここは狭間。二つの相が割れたとき、そのあわいに取り残された場所。\n割れた足場が虚に浮かび、時も方位も溶けている。', col: '#1a1030', col2: '#b088e8', icon: '🌀', d: 5400, audio: 'riser' },
    { text: '世界が一つだった頃の残響が、ここにだけ淀んでいる。\n——裂けた世界を還すための最後の鍵は、この隙間にこそ眠るのかもしれない。', col: '#120a24', col2: '#d0b8ff', icon: '✦', d: 5400, audio: 'shimmer' },
  ] },
];
